package com.convertisseur_ListActivity.afpa1797.convertisseur_SQlite;
...
public class Convert {
     ...
     */
    public static String[] getDevises(Context context) {

        DeviseDAO deviseDAO = new DeviseDAO(context);
        ArrayList<Devise> devises ;

        deviseDAO.open();

        devises = deviseDAO.getAll();
        String[] listeDevises = new String[devises.size()];
