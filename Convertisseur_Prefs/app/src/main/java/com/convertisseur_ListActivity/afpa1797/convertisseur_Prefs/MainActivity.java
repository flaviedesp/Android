package com.convertisseur_ListActivity.afpa1797.convertisseur_Prefs;
    ...
    public void onClickConvertir(View btn) {
        ...
        try {
           doConversion();
            ...
            int id = getResources().getIdentifier(nomRessource,"string", "com.example.afpa1797.convertisseur_Prefs");
